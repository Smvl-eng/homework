...
// console.log(`Скидка в размере ${discount}`);
...
// const type = prompt(
//   "Выберите тип посылки из трех перечисленных:\n- Стандарт\n- Экспресс\n- Премиум",
// );
...
// if (weight <= 0) {
//   alert("Ошибка: Некорректный вес посылки");
// }
// if (type !== "Стандарт" && type !== "Экспресс" && type !== "Премиум") {
//   alert("Неверный тип доставок");
// }
...
// let basePrice = weight;

// if (basePrice < 1) {
//   alert("Базовая стоимость посылки состовляет 5$");
// } else if (basePrice <= 5) {
//   alert("Базовая стоимость посылки состовляет 10$");
// } else if (basePrice > 5) {
//   alert("Базовая стомость посылки состовляет 15$");
// } else if ((basePrice = null)) {
//   alert("Базовая стомость посылки состовляет 0$");
// }
